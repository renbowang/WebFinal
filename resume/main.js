...
let pageMethods = {
    displaySummary(){
        this.summary = `${this.name} : 
                        ${this.graduationList[this.graduationIndex]}畢業,
                        社團經驗:${this.club_experience},
                        ${this.work_experience}工作經驗 ${this.statusList[this.selectedIndex]}`;
    },
    calculate(){
